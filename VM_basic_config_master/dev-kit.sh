...
echo "/simple_grid 194.12.159.48(rw,sync,no_root_squash,no_subtree_check) simple-lc01.cern.ch(rw,sync,no_root_squash,no_subtree_check) simple-lc02.cern.ch(rw,sync,no_root_squash,no_subtree_check)"
echo ""
echo "*********************************"
